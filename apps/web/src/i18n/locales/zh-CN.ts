...
export const zhCN: Dict = {
  ...
  'settings.subtitle': '在内置 Pi agent 与 BYOK 之间选择。API Key 只保存在当前浏览器中。',
  'settings.modeAria': '执行模式',
  'settings.protocolAria': 'API 协议',
  'settings.modeDaemon': 'Pi agent',
  'settings.modeDaemonHelp': '通过 daemon 内嵌的 Pi SDK agent 执行',
  'settings.modeDaemonOffline': '后台守护进程未运行',
  'settings.modeDaemonOfflineMeta': '守护进程未运行',
  'settings.modeDaemonInstalledMeta': '可用 {count} 个',
  'settings.modeApi': 'API 提供方',
  'settings.modeApiMeta': 'BYOK',
  'settings.codeAgent': '代码代理',
  'settings.codeAgentHint': '由 Node.js daemon 内的 Pi 驱动。选择 Pi 生成时使用的模型。',
  'settings.rescan': '↻ 刷新',
  'settings.rescanTitle': '刷新 Pi runtime 状态',
  'settings.rescanRunning': '刷新中...',
  'settings.rescanSuccess': '刷新完成，{count} 个内嵌 agent 可用。',
  'settings.rescanFailed': '刷新失败，请检查后台守护进程后重试。',
  'settings.test': '测试',
  ...
  'settings.testAgentMissing': '{agentName} 在当前 daemon 中不可用。',
  ...
  'settings.agentInstall.pathHint':
    'daemon 现在通过 SDK 内嵌 Pi，不再需要配置本地 coding-agent CLI 路径。',
  ...
  'settings.agentInstall.stepRescan': '在此区域点击“刷新”。',
  'settings.agentInstall.stepSelect': '当 Pi agent 可用后，选择该 agent 卡片。',
  'settings.noAgentsDetected':
    '当前 daemon build 中不可用 Pi SDK。请重新安装依赖后刷新。',
  ...
  'settings.modelPickerHint':
    '当 Pi 凭据可用时会自动拉取。选择「默认」则沿用 Pi 设置；选择「自定义」可手动输入任何 Pi 模型模式。',
  'settings.cliEnvTitle': 'Runtime 配置位置',
  'settings.cliEnvHint':
    '为打包版应用运行和 MCP 集成保留的可选非敏感路径。',
  'settings.cliEnvClaudeConfigDir': 'Claude 兼容配置目录',
  ...
  'chat.cliSettingsTitle': 'Pi agent 与模型设置',
  'chat.cliSettingsAria': '打开 Pi agent 与模型设置',
  ...
  'agentPicker.localCli': 'Pi agent',
  'agentPicker.daemonOff': '守护进程未运行',
  'agentPicker.byok': 'API · BYOK',
  'agentPicker.selectAgent': '选择 daemon 内嵌的 Pi agent',
  'agentPicker.noAgents': '没有内嵌 agent',
  'agentPicker.notInstalled': '未安装',
  'agentPicker.rescan': '刷新内嵌 agent',
