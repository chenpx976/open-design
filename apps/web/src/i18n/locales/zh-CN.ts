...
export const zhCN: Dict = {
  ...
  'settings.subtitle': 'Choose between the built-in Pi agent and BYOK. Your API key is stored only in this browser.',
  'settings.modeAria': '执行模式',
  'settings.protocolAria': 'API 协议',
  'settings.modeDaemon': 'Pi agent',
  'settings.modeDaemonHelp': 'Run through the daemon-hosted Pi SDK agent',
  ...
  'settings.testAgentMissing': '{agentName} is not available in the daemon.',
  ...
  'avatar.useLocal': 'Use Pi agent',
  'avatar.useApi': '使用 API · BYOK',
  'avatar.codeAgent': '代码代理',
  'avatar.rescan': 'Refresh agents',
  'avatar.settings': '设置',
  ...
  'agentPicker.selectAgent': 'Select the daemon-hosted Pi agent',
  'agentPicker.noAgents': 'no embedded agents',
  'agentPicker.notInstalled': '未安装',
  'agentPicker.rescan': 'Refresh embedded agents',
