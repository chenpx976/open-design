...
Skill development uses the same embedded Pi runtime as product runs. Configure model access in Settings; BYOK provider proxy mode remains available for model/provider experiments.
